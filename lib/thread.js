...
ERROR_ARG_1 = 'thread_obj.create first argument must be a run thread function or a poolsize';
...
thread_obj.create = function(func, opt, cb){
	...
	opt.fastthread = 'undefined' === typeof opt.fastthread ? true : false; //默认使用快速线程
